    ...
    return (
        ...
        <div className="p-4 m-4 bg-emerald-900 rounded-lg">
            <form>
                ...
                <button type="submit" onClick={addChallenge} className='bg-green-950 font-bold text-center text-lg py-2 px-5 rounded-lg border-2 border-green-700'>Create!</button>
            </form>
        </div>
    )
}
    ...
    return (
        ...
        <div className="p-4 m-4 bg-emerald-700 rounded-lg">
            <div className="flex justify-between">
                ...
                <button onClick={handleAddChallenge} className='bg-green-950 font-bold text-center text-lg py-2 px-5 rounded-lg border-2 border-green-700'><span className="text-xl">+</span> Create Challenge</button>
            </div>
            {
