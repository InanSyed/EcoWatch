    ...
    return (
        ...
        <div className="p-4 m-4 bg-emerald-700 rounded-lg">
            <div className="flex justify-between">
                ...
                {
                    !joinStatus
                        ? <button onClick={handleJoin} className='bg-green-700 font-bold text-center text-lg py-2 px-5 rounded-lg border-2 border-green-900'>{buttonText}</button>
                        : <button onClick={handleLeave} className='bg-red-700 font-bold text-center text-lg py-2 px-5 rounded-lg border-2 border-red-900'>Leave</button>
                }
            </div>
        </div>
    )
